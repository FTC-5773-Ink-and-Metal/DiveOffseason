...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks =  -6491.74897773292; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1661.514313119745; // x position of the perpendicular encoder (in tick units)
    }
